...
var FormComponent = (function () {
    function FormComponent(_utilService, _assignationsuiviService, http) {
    ...
    FormComponent.prototype.getZoneActivite = function () {
        var _this = this;
        this._utilService.getZoneActivite()
            .subscribe(function (data) {
            _this.zonesactivites = data;
            _this.options = _this.zonesactivites.activites.map(function (type) {
    ...
    FormComponent.prototype.validernewclient = function () {
        ...
        this._utilService.insertPoint(this.client)
            .subscribe(function (data) { return console.log(data); }, function (error) { return alert(error); }, function () { return console.log('insertPoint'); });
    };
