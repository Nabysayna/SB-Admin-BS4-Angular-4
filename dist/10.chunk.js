...
var ComptableComponent = (function () {
    ...
    ComptableComponent.prototype.getListBilanDeposit = function () {
        var _this = this;
        ...
        }, function (error) { return alert(error); }, function () { return console.log('listebilandeposit'); });
    };
