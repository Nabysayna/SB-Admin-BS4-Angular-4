...
var MarketingcomComponent = (function () {
    ...
    MarketingcomComponent.prototype.validmodifyadressepoints = function () {
        ...
        this._apiPlatformService.validModifyAdressePoint(this.pointsdepoye)
            ...
            _this.listepointsdepoye = _this.listepointsdepoye.filter(function (opt) { return !(opt.telephone_gerant == _this.pointsdepoye.telephone_gerant && opt.login == _this.pointsdepoye.login); });
            _this.pointsdepoye = undefined;
        });
    };
