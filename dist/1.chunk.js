...
/***/ "../../../../../src/app/layout/suivionepoint/filterdata-suividemandepotcc.pipe.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_lodash___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_lodash__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_core__ = __webpack_require__("../../../core/@angular/core.es5.js");
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return DataFilterSuiviDemandepositccPipe; });
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var DataFilterSuiviDemandepositccPipe = (function () {
    function DataFilterSuiviDemandepositccPipe() {
    }
    DataFilterSuiviDemandepositccPipe.prototype.transform = function (array, query) {
        if (query) {
            return __WEBPACK_IMPORTED_MODULE_0_lodash__["filter"](array, function (row) {
    ...
    return DataFilterSuiviDemandepositccPipe;
}());
DataFilterSuiviDemandepositccPipe = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__angular_core__["Pipe"])({
        name: "dataFilterSuiviDemandepositcc"
    })
], DataFilterSuiviDemandepositccPipe);

//# sourceMappingURL=filterdata-suividemandepotcc.pipe.js.map
...
var SuivionepointComponent = (function () {
    function SuivionepointComponent(_suivipositionnementService, _apiPlatformService, modalService) {
    ...
    SuivionepointComponent.prototype.menuHeadClick = function (option) {
        ...
        if (option == 4) {
            ...
            this.killsetinterval = setInterval(function () {
                _this.getListStatusDepositionCC();
    ...
    SuivionepointComponent.prototype.getCategorie = function (categorie) {
        ...
        if (categorie == 'Pas de depot Avec caution') {
            ...
            this.listepointsbycc = this.gardeListepointsbycc.filter(function (type) { return type.categorie == 'pasdepot_aveccaution'; });
        }
        if (categorie == 'Faible') {
    ...
    SuivionepointComponent.prototype.suivionepointgraphe = function () {
        ...
        if (isjour) {
            this.touslesjours = this.touslescommissions.map(function (type) { return type.dateop_heure; });
        }
        else {
        ...
        var nbrebyjouremoney = [];
        var nbrebyjourtigocash = [];
        if (isjour) {
            tabjours.forEach(function (type) {
                ...
                var nbrebyjouremoneySom = 0;
                var nbrebyjourtigocashSom = 0;
                _this.touslescommissionsbyGerant.forEach(function (opt) { if (opt.dateop_heure == type && opt.service == 'orangemoney') {
                    nbrebyjouromSom += Number(opt.montant);
                } });
                nbrebyjourom.push(nbrebyjouromSom);
                _this.touslescommissionsbyGerant.forEach(function (opt) { if (opt.dateop_heure == type && opt.service == 'tnt') {
                    nbrebyjourtntSom += Number(opt.montant);
                } });
                nbrebyjourtnt.push(nbrebyjourtntSom);
                _this.touslescommissionsbyGerant.forEach(function (opt) { if (opt.dateop_heure == type && opt.service == 'postcash') {
                    nbrebyjourpostSom += Number(opt.montant);
                } });
                nbrebyjourpost.push(nbrebyjourpostSom);
                _this.touslescommissionsbyGerant.forEach(function (opt) { if (opt.dateop_heure == type && opt.service == 'wizall') {
                    nbrebyjourwizallSom += Number(opt.montant);
                } });
                nbrebyjourwizall.push(nbrebyjourwizallSom);
                _this.touslescommissionsbyGerant.forEach(function (opt) { if (opt.dateop_heure == type && opt.service == 'emoney') {
                    nbrebyjouremoneySom += Number(opt.montant);
                } });
                nbrebyjouremoney.push(nbrebyjouremoneySom);
                _this.touslescommissionsbyGerant.forEach(function (opt) { if (opt.dateop_heure == type && opt.service == 'tigocash') {
                    nbrebyjourtigocashSom += Number(opt.montant);
                } });
                nbrebyjourtigocash.push(nbrebyjourtigocashSom);
            });
        }
        else {
            tabjours.forEach(function (type) {
                ...
                nbrebyjourwizall.push(nbrebyjourwizallSom);
                _this.touslescommissionsbyGerant.forEach(function (opt) { if (opt.dateop_jour == type && opt.service == 'emoney') {
                    nbrebyjouremoneySom += Number(opt.montant);
                } });
                nbrebyjouremoney.push(nbrebyjouremoneySom);
                _this.touslescommissionsbyGerant.forEach(function (opt) { if (opt.dateop_jour == type && opt.service == 'tigocash') {
                    nbrebyjourtigocashSom += Number(opt.montant);
                } });
                nbrebyjourtigocash.push(nbrebyjourtigocashSom);
            });
    ...
    SuivionepointComponent.prototype.suivionepointdetail = function () {
        ...
        this.touslescommissionsbyGerant.forEach(function (type) {
            _this.bilantouslescommissionsbyGerant[6].liste.push(type);
            _this.bilantouslescommissionsbyGerant[6].commission += type.commission;
            if (type.service == 'tnt') {
                ...
                _this.bilantouslescommissionsbyGerant[6].cashin += Number(type.montant);
            }
            ...
            if (type.service == 'emoney') {
                if (type.produit == 'depot') {
                    ...
                    _this.bilantouslescommissionsbyGerant[6].cashout += Number(type.montant);
                }
            ...
            if (type.service == 'tigocash') {
                if (type.produit == 'depot') {
                    _this.bilantouslescommissionsbyGerant[5].cashin += Number(type.montant);
                    _this.bilantouslescommissionsbyGerant[6].cashin += Number(type.montant);
                }
                else {
                    _this.bilantouslescommissionsbyGerant[5].cashout += Number(type.montant);
                    _this.bilantouslescommissionsbyGerant[6].cashout += Number(type.montant);
                }
                _this.bilantouslescommissionsbyGerant[5].liste.push(type);
                _this.bilantouslescommissionsbyGerant[5].commission += type.commission;
            }
        });
    };
    ...
    SuivionepointComponent.prototype.closedModal = function () {
        this.modalRef.close('Close click');
    };
    SuivionepointComponent.prototype.showModalFaireUnDepot = function (content, item) {
        this.montantfairedepot = undefined;
        this.pointdemandedepot = item;
        this.modalRef = this.modalService.open(content);
    };
    SuivionepointComponent.prototype.valideFaireUnDepotByCC = function () {
        var _this = this;
    ...
    SuivionepointComponent.prototype.getListStatusDepositionCC = function () {
        var _this = this;
        this._apiPlatformService.getListStatusDepositioncc()
            .subscribe(function (data) {
            _this.listestatusdepositionCC = data.message.map(function (type) {
            ...
            if (_this.listestatusdepositionCC.length == 0) {
                clearInterval(_this.killsetinterval);
            }
        }, function (error) { return alert(error); }, function () {
            _this.loading_data = false;
        });
    };
    SuivionepointComponent.prototype.getReclamationsNonResolu = function () {
        var _this = this;
    ...
    SuivionepointComponent.prototype.validresolutionreclamation = function (reclamation) {
...
SuivionepointComponent = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
        ...
        providers: [__WEBPACK_IMPORTED_MODULE_1__services_util_service__["a" /* UtilService */], __WEBPACK_IMPORTED_MODULE_3__services_apiplateform_service__["a" /* ApiPlatformService */], __WEBPACK_IMPORTED_MODULE_5__services_suivipositionnement_service__["a" /* SuivipositionnementService */]]
    }),
    __metadata("design:paramtypes", [typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_5__services_suivipositionnement_service__["a" /* SuivipositionnementService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_5__services_suivipositionnement_service__["a" /* SuivipositionnementService */]) === "function" && _c || Object, typeof (_d = typeof __WEBPACK_IMPORTED_MODULE_3__services_apiplateform_service__["a" /* ApiPlatformService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_3__services_apiplateform_service__["a" /* ApiPlatformService */]) === "function" && _d || Object, typeof (_e = typeof __WEBPACK_IMPORTED_MODULE_2__ng_bootstrap_ng_bootstrap__["b" /* NgbModal */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__ng_bootstrap_ng_bootstrap__["b" /* NgbModal */]) === "function" && _e || Object])
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_23__suivionepoint_filterdata_suividemandepotcc_pipe__ = __webpack_require__("../../../../../src/app/layout/suivionepoint/filterdata-suividemandepotcc.pipe.ts");
...
SuperviseurModule = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
        ...
        declarations: [
            ...
            __WEBPACK_IMPORTED_MODULE_23__suivionepoint_filterdata_suividemandepotcc_pipe__["a" /* DataFilterSuiviDemandepositccPipe */],
