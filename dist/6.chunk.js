...
var DataFilterPipe = (function () {
    ...
    DataFilterPipe.prototype.transform = function (array, query) {
        if (query) {
            return __WEBPACK_IMPORTED_MODULE_0_lodash__["filter"](array, function (row) { return (row.libellepoint.toLowerCase().indexOf(query.toLowerCase()) > -1 || row.fullname_gerant.toLowerCase().indexOf(query.toLowerCase()) > -1 || row.fullname_proprietaire.toLowerCase().indexOf(query.toLowerCase()) > -1 || row.email_gerant.toLowerCase().indexOf(query.toLowerCase()) > -1 || row.adresse.toLowerCase().indexOf(query.toLowerCase()) > -1); });
        }
        return array;
    };
...
MesContactsComponent = __decorate([
    ...
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1__ng_bootstrap_ng_bootstrap__["c" /* NgbModal */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__ng_bootstrap_ng_bootstrap__["c" /* NgbModal */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_3__services_util_service__["a" /* UtilService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_3__services_util_service__["a" /* UtilService */]) === "function" && _b || Object])
    ...
    ModifPdvComponent.prototype.ngOnInit = function () {
        ...
        this._utilService.getRegionZoneActivite()
            ...
            _this._utilService.getAllDataPoint(_this.infoprospect.id)
                ...
                console.log(_this.alldatapoint.nom_point);
                _this.avoter(_this.alldatapoint.avis - 1);
                _this.adresse_point = JSON.parse(_this.alldatapoint.adresse_point);
                _this.adresse_point.regionpoint = JSON.parse(_this.alldatapoint.adresse_point).regionpoint ? JSON.parse(_this.alldatapoint.adresse_point).regionpoint : '';
