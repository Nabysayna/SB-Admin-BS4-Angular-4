...
var ProspectPdvComponent = (function () {
    ...
    ProspectPdvComponent.prototype.ngOnInit = function () {
        ...
        this._utilService.getRegion()
            .subscribe(function (data) { return _this.regions = data; }, function (error) { return alert(error); }, function () {
            _this._utilService.getZoneActivite()
                .subscribe(function (data) {
                ...
                _this._utilService.getAllDataPoint(_this.infoprospect.id_point)
                    ...
                    _this.adresse_point = {
                        regionpoint: _this.adresse_point.regionpoint ? _this.adresse_point.regionpoint : '',
                        zonepoint: _this.adresse_point.zonepoint ? _this.adresse_point.zonepoint : undefined,
                        souszonepoint: _this.adresse_point.souszonepoint ? _this.adresse_point.souszonepoint : undefined,
                        adressepoint: _this.adresse_point.adressepoint ? _this.adresse_point.adressepoint : undefined,
                        codepostalpoint: _this.adresse_point.codepostalpoint ? _this.adresse_point.codepostalpoint : 0,
                        geospatialpoint: _this.adresse_point.geospatialpoint ? _this.adresse_point.geospatialpoint : { latitude: 0, longitude: 0 }
                    };
                    //console.log(this.adresse_point);
                }, function (error) { return alert(error); }, function () {
                    _this._utilService.getZoneByRegion(_this.adresse_point.regionpoint)
                        .subscribe(function (data) { return _this.zonespoints = data; }, function (error) { return console.log(error); }, function () {
    ...
    ProspectPdvComponent.prototype.getRegion = function () {
        var _this = this;
        this._utilService.getRegion()
            .subscribe(function (data) {
            _this.regions = data;
    ...
    ProspectPdvComponent.prototype.selectRegionPoint = function () {
        var _this = this;
    ...
    ProspectPdvComponent.prototype.selectZoneProprietaire = function () {
        ...
        this._utilService.getSouszoneByZone(this.adresse_proprietaire.zoneproprietaire)
            .subscribe(function (data) { return _this.souszonespropietaires = data; }, function (error) { return alert(error); }, function () { return console.log(''); });
    };
    ProspectPdvComponent.prototype.coordonneesgeospatiales = function () {
        var _this = this;
        if (navigator.geolocation) {
            navigator.geolocation.getCurrentPosition(function (position) {
                _this.adresse_point.geospatialpoint.longitude = position.coords.longitude;
                _this.adresse_point.geospatialpoint.latitude = position.coords.latitude;
            });
        }
    };
...
var TablesComponent = (function () {
    ...
    TablesComponent.prototype.ngOnInit = function () {
        ...
        this._assignationsuiviService.getAssignationsByCommercial()
            ...
            _this.data = data.message.map(function (type) {
                return {
                    ...
                    prenom: type.p_prenom,
                    nom: type.p_prenom,
                    fullname: type.p_prenom + " " + type.p_nom,
                    telephone: type.p_telephone,
                    adresse: JSON.parse(type.p_adresse_point).adressepoint,
        ...
        }, function (error) { return alert(error); }, function () { return console.log('getAssignationsByCommercial'); });
    };
