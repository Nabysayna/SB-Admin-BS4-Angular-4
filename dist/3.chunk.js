...
var ProspectPdvComponent = (function () {
        ...
        this._utilService.getRegion()
            ...
            _this._utilService.getZoneActivite()
                ...
                _this._utilService.getAllDataPoint(_this.infoprospect.id_point)
                    ...
                    console.log(_this.adresse_point);
                    _this.adresse_point = {
                        regionpoint: _this.adresse_point.regionpoint ? _this.adresse_point.regionpoint : 'Dakar',
                        zonepoint: _this.adresse_point.zonepoint ? _this.adresse_point.zonepoint : 'Dakar',
                        souszonepoint: _this.adresse_point.souszonepoint ? _this.adresse_point.souszonepoint : 'Dakar',
                        adressepoint: _this.adresse_point.adressepoint ? _this.adresse_point.adressepoint : '',
                    ...
                    _this._utilService.getZoneByRegion(_this.adresse_point.regionpoint)
                        .subscribe(function (data) { return _this.zonespoints = data; }, function (error) { return alert(error); }, function () {
    ...
    ProspectPdvComponent.prototype.getRegion = function () {
        ...
        this._utilService.getRegion()
            .subscribe(function (data) {
            _this.regions = data;
        }, function (error) { return alert(error); }, function () { return console.log(_this.regions); });
    };
    ...
    ProspectPdvComponent.prototype.coordonneesgeospatiales = function () {
        ...
        if (navigator.geolocation) {
            navigator.geolocation.getCurrentPosition(function (position) {
                ...
                console.log('test 1');
                console.log(_this.adresse_point.geospatialpoint);
            });
        }
    };
