...
@Component({
  selector: 'app-superviseurtest1',
  templateUrl: './superviseurtest1.component.html',
  styleUrls: ['./superviseurtest1.component.scss']
})
export class Superviseurtest1Component implements OnInit {
	fakevalues = true ;
    selection = "" ;
    public isSuivi=true;
