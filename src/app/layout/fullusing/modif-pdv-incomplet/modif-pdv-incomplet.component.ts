...
@Component({
    ...
    templateUrl: 'modif-pdv-incomplet.component.html',
    styleUrls: ['modif-pdv-incomplet.component.scss'],
    animations: [routerTransition()],
    providers:[AssignationSuiviService]
})
export class ModifPdvIncompletComponent implements OnInit, OnDestroy {
    ...
    constructor(private location: Location, private _utilService:UtilService, private _assignationsuiviService:AssignationSuiviService, private http: Http, public router: Router) { }
